...
class StationDownloadManager: ObservableObject {
    ...
    func getStation(by id: String) -> MusicStation {
        ...
        case "lofi":
            return lofiStation
        case "piano":
            return MusicStation(id: "piano", name: "PIANO", songCount: 0, totalSizeMB: 0, color: Color(red: 0.6, green: 0.4, blue: 1.0), isAvailable: false, songs: [])
        case "hiphop":
            return MusicStation(id: "hiphop", name: "HIPHOP", songCount: 0, totalSizeMB: 0, color: Color(red: 1.0, green: 0.4, blue: 0.6), isAvailable: false, songs: [])
        case "jungle":
            return MusicStation(id: "jungle", name: "JUNGLE", songCount: 0, totalSizeMB: 0, color: Color(red: 0.4, green: 0.8, blue: 0.4), isAvailable: false, songs: [])
        default:
            return lofiStation
        }
    }
